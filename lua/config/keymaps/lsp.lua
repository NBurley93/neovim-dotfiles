...
function M.config(client, bufnr)
    lsp_map("gd", function() vim.cmd("Glance definitions") end, bufnr, "View definitions")
    lsp_map("gr", function() vim.cmd("Glance references") end, bufnr, "View references")
    lsp_map("gy", function() vim.cmd("Glance type_definitions") end, bufnr, "View type definitions")
